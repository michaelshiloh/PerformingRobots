...
* Homework assignment due Tuesday October 3
	...
	* Create
		three "sketches" or idea that convey the kind of actor that interests you
	...
	* Start creating 1 very low-fidelity draft. Cardboard and masking tape
	  is fine. It does not need to be
		...
		The purpose of this exercise is to convey to 
		...
		but it must be functional by October 12 (more on this later).
