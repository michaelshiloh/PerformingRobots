...
Quick
[link](https://github.com/michaelshiloh/PerformingRobots/blob/master/schedule.md#current-homework-assignment)
...
machine lab
Week  1 - Hand crank automata   
Week  2 - DC motors, soldering, motorized automata    
Week  3 - Arduino, Fusion 360, laser cutter
Week  4 - Servo motors, stepper motors, motor shields
Week  5 - Solenoids, start work on drawing machines
Week  6 - Drawing machines, construction techniques   
Week  7 - hand tool training
Week  8 - Scene ship training, marble elevators   
Week  9 - Scene ship training, marble elevators   
Week 10 - Scene ship training, marble elevators, Rube Goldberg   
Week 11 - Rube Goldberg, manual reset   
Week 12 - Rube Goldberg, manual reset   
Week 13 - Rube Goldberg, automatic reset   
Week 14 - Rube Goldberg, automatic reset   
Week 15: End of semester show  
...
class 
1 - intro to arduino
2 - motor control, motor shield
3 - test motor shield
4 - build motorized platform
5 - sensors, behaviours
6 - bluetooth
7 - no class
8 - bluetooth robots due, multitasking
9 - midterm project introduction
10 - 
11
12
13 - midterm due
14 - fritzing (probably too late)
15 
16 - open studios robot

fall 2019
week
1 - intro to arduino, sensors, soldering
2 - motor control, motor shield
3 - cardboard prototyping, soldering
4 - project 1: build motorized platform
5 - remote control, bluetooth, midterm project introduction
6 - scene shop training?
7 - no class
8 - project 2: midterm
9 - midterm grades due?
10 - introduce final
11 - 
12 - project 3: prototype functional
13 - 
14 - fritzing (probably too late)
...
- Create a GitHub account and create a repository for this class. 
	...
	The repository name should be something like "PerformingRobots" (no spaces are allowed)
...
- Try to design a box into which you can mount a [Nema 17
	motor](https://www.adafruit.com/product/324) and two 
	flanged bearings
	![](https://ci3.googleusercontent.com/proxy/asSLS6gK7qYB79tJjygz8eWQVb-2ZCnYtWYN9NF9S9InVNCl75kqQl-ZtrC4w7xfvRTJPJANpxa4lItJWiyyG6LTz9zzsDhc6zEuL0tnlSKsVPQ3W6oNW6Lvn1oLCKo=s0-d-e1-ft#https://github.com/michaelshiloh/PerformingRobots/raw/master/images/boxPicture.jpg)
...
- Export the front surface of your enclosure, 
	...
	- You can see my file in 
		https://github.com/michaelshiloh/PerformingRobots/tree/master/dxfFiles
