...
* Homework assignment due Saturday September 16  
	As we discussed in class, get your robots built and capable of moving. 
	Simplify
...
* Farfalle update
	* You can visit the Farfalle 
		"virtual playground" 
		installation on Tuesday, October 3rd 
		between 4-8pm
	* If you want to attend any of the performances, send 
...
* Homework assignment due Tuesday October 3
	...
	assignment: I want you to start giving shape to your ideas so that we
	can discuss in class on Tuesday, and so that you can start making 
	something that you can show to the Software Art students on October 12.

	The goal here is to generate ideas and to convey a style or direction, 
	and emphatically not to imagine the actor you will build for the
	final project.

	If you have other ways to show ideas and to express yourselves
	send me email and most likely I'll allow that instead of the assignment 
	below.

	* Create
		**three** "sketches" that somehow convey the kind of actor 
		that interests you
		or the kind of world that you want your actor to inhabit.
		These sketches might take a variety of forms, including, but 
		not limited to:
		* drawings (on paper, screen, napkins, whatever)
		* wire figures
		* [paper cut
		out](https://i.pinimg.com/originals/30/85/2e/30852e06a64adf69c31a5f66b62b3142.jpg)
	...
	* Visit the Cube gallery and view the images generated by 
		the Software Art: Image class
...
* Concept: What personality did you want to portray in your actor? 
	How did you use technology to accomplish this?
...
* What did you have to learn in order to complete your project? 
	How did you learn this? (Include links to any useful resources)
