...
on November 28: robot body and robot mechanics. The assignment now is:
...
### todays-assignment
#### Assignments Due Wednesday December 7

- Robot can drive using the remote control
- Robot servos and NeoPixels work through the radio (i.e. instructions to the
	servo motors and NeoPixels are coming from the transmitter Arduino and being
	sent to the receiver Arduino via the radio. The receiver Arduino receives
	the message and then activates the servo motors and NeoPixels.
